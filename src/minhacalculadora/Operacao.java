...
public enum Operacao{
    ADICAO("+", "1ª parcela", "2ª parcela", "Soma"), MULTIPLICACAO("*", "Multiplicando", "Multiplicador", "Produto"),
    SUBTRACAO("-", "Minuendo  ", "Subtraendo", "Resto"), OPCAOINVALIDA("Opção inválida!", "Divisor inválido!", "", ""),
    DIVISAO("/", "Dividendo", "Divisor  ", "Quociente"), SAIR("S", "", "", "");
    ...
    public boolean naoEhDivisaoInvalida(){
        if(!(this.equals(Operacao.DIVISAO) && this.valoresDosTermos[1] == 0))
            return true;
    ...
    public void mostrarResto(){
        if(this.equals(Operacao.DIVISAO) && divisao.getMod() != 0)
